...
if __name__ == '__main__':
    ...
    # for rir_string in [rir_dirs[0]]:
        ...
        work_dir = home + '/mac/hpc/rtf_estimators/ssn/gevd/' + rir_string
        ...
        # for i in range(1):
            ...
            command = "python3 /rds/general/user/dtj20/home/mac/hpc/rtf_estimators/ssn/gevd/gevd_exp.py " + str(batch_size) + ' '
