...
if __name__ == '__main__':
    ...
    work_dir = home + '/mac/hpc/rtf_estimators/white_noise/pm_pevd/'
    ...
    for i in range(N_jobs):
        ...
        command = "python3 /rds/general/user/dtj20/home/mac/hpc/rtf_estimators/pm_pevd/pm_pevd_exp.py " + str(batch_size) + ' '
