...
if __name__ == '__main__':
    ...
    work_dir = home + '/mac/hpc/rtf_estimators/gevd/'
    ...
    for i in range(N_jobs):
        ...
        walltime = "02:00:00"
        processors = "-lselect=1:ncpus=8:mem=8gb"
        command = "python3 /rds/general/user/dtj20/home/mac/hpc/rtf_estimators/gevd/gevd_exp.py " + str(batch_size) + ' '
