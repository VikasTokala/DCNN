...
ax1.set_title( 'Left Channel',fontname="Times New Roman",fontweight='bold', fontsize='20')
 
ax1.label_outer()
ax1.set_xlabel('Time [s]', fontname="Times New Roman",fontweight='bold',fontsize='20')
ax1.set_ylabel('Frequency [kHz]', fontname="Times New Roman",fontweight='bold',fontsize='20')
...
ax2.label_outer()
ax2.set_xlabel('Time [s]', fontname="Times New Roman",fontweight='bold',fontsize='20')
# ax2.tick_params(axis='y', which='major', labelsize=14)
ax2.tick_params(axis='x', which='major', labelsize=16)
ax2.set_title( 'Right Channel',fontname="Times New Roman",fontweight='bold', fontsize='20')
# ax2.set_ylabel('Frequency (Hz)', fontname="Times New Roman",fontweight='bold')
# fig.colorbar(img1,ax=[ax1,ax2],format="%+2.0f dB")
cbar = fig.colorbar(img1,ax=[ax1,ax2],format="%+2.0f dB")
cbar.ax.tick_params(labelsize=14)

D = mask.numpy()
img1 = librosa.display.specshow(D, y_axis='hz', x_axis='time',
                                sr=16000, ax=ax3,hop_length=win_inc, win_length=win_len)
ax3.set_title('Binary Mask',fontname="Times New Roman",fontweight='bold', fontsize='20')

ax3.set_xlabel('Time [s]', fontname="Times New Roman",fontweight='bold', fontsize='20')
...
# img1 = librosa.display.specshow(D, y_axis='hz', x_axis='time',
#                                 sr=16000, ax=ax1,hop_length=win_inc, win_length=win_len)
# ax1.set_title('Noisy speech (Left Ch.)',fontname="Times New Roman",fontweight='bold', fontsize='20')
# ax1.set_xlabel('Time [s]', fontname="Times New Roman",fontweight='bold',fontsize='20')
# ax1.set_ylabel('Frequency [Hz]', fontname="Times New Roman",fontweight='bold',fontsize='20')
# ax1.label_outer()
